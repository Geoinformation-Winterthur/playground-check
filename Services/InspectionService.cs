...
namespace playground_check.Services
{
    ...
    public class InspectionService : IInspectionService
    {
        ...
        public ErrorMessage SendReport(InspectionReport[] inspectionReports,
                        ClaimsPrincipal user, bool dryRun = false)
        {
                        ...
                        inspectionReports.Length == 0)
            {
                ...
                return result;  // Es wurden keine Kontrollberichte empfangen.
            }
            ...
            using (NpgsqlConnection pgConn = new NpgsqlConnection(AppConfig.connectionString))
            {
                ...
                try
                {
                    ...
                    inspectionTid = InspectionService.writeInspection(
                                        inspectionReports[0],
