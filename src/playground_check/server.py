...
def create_router() -> Router:
    ...
    router.add("POST", r"/Document/?", service.post_document)
    router.add("PUT", r"/Document/(?P<fid>\d+)/Name/?", service.rename_document)
    router.add("DELETE", r"/Document/(?P<fid>\d+)/?", service.delete_document)
